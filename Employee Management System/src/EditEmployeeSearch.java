...
public class EditEmployeeSearch extends javax.swing.JFrame {
    ...
    private void SubmitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitButtonActionPerformed
        ...
        try {
            ...
            if (refNumber != null) {
                DisplayEdit editFrame = new DisplayEdit();
                editFrame.setVisible(true);
                editFrame.setHomepage(homepageFrame);
                editFrame.setRefVal(refNumber);
                editFrame.setCancel(this);
                editFrame.setMainHT(table);
